      ...
      body: ListView(
        ...
        children: const [
          ...
          _TermSection(
            title: '2. User Roles',
            body:
            'EduNest has four main roles: learner, parent/student, tutor, and administrator. '
                'Learners can book sessions and make payments. Tutors can create courses after being verified. '
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text('Platform: EduNest'),
            Text('Effective Date: [Enter effective date]'),
            Text('Operated by: [Team/Company/Individual name]'),
            Text('Support Email: [Support email]'),
            SizedBox(height: 12),
            Text(
...
class _Footer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      'Note: These are sample terms of service for the EduNest project. If used for a real product, they should be reviewed by a qualified legal professional.',
